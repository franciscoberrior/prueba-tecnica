...
@Slf4j
@Service
public class ProcessPublisherDeleteClientAdapter implements ProcessPublisherService {

  private static final String EVENT_QUEUE = "DELETE_CLIENT";
  ...
  public ProcessClientTypeEnum type() {
    return ProcessClientTypeEnum.DELETE;
  }
