...
@Slf4j
@Service
public class ProcessPublisherUpdateClientAdapter implements ProcessPublisherService {

  private static final String EVENT_QUEUE = "UPDATE_CLIENT";
  ...
  public ProcessClientTypeEnum type() {
    return ProcessClientTypeEnum.UPDATE;
  }
